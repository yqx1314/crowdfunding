                ...
                <div class="panel-body">
                    <form id="roleForm" role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            <%--@declare id="unassign"--%><label for="unAssign">未分配角色列表</label><br>
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            <%--@declare id="assign"--%><label for="assign">已分配角色列表</label><br>
    ...
    $(function () {
        ...
        $("#right2LeftBtn").click(function(){
            ...
            if ( opts.length == 0 ) {
                ...
                $.ajax({
                    type : "POST",
                    url  : "${pageContext.request.contextPath}/user/dounAssign",
                    data : $("#roleForm").serialize(),
                    success : function(result) {
                        if ( result.success ) {
